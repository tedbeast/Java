...
public class FilterColumnsTest {
     ...
     * Notice in the method above that has the @Before annotation we have created the users table and inserted 5 records.
     *
     * This test calls the method with the SQL syntax that you wrote and then we are retrieving everything in the users table to ensure that only the lastname column was returned.
     */
    @Test
     ...
     * Notice in the method above that has the @Before annotation we have created the users table and inserted 5 records.
     *
     * This test calls the method with the SQL syntax that you wrote and then we are retrieving everything in the users table to ensure that only the firstname and lastname were returned.
     */
    @Test
