package Chapter4.SQL.DQL._17_INNER_JOIN;
...
public class InnerJoinActivity {
    ...
    public Set<Pair<Integer, String>> innerJoin1() {
        ...
        String sql = "SELECT students.id, student FROM faculty INNER JOIN students ON faculty.class = students.class WHERE faculty.teacher = 'Mr. McCarthy';";//TODO: reference SQL - remove me
    ...
    public Set<ExampleEntity> innerJoin2() {
        /**
        ...
        //Write your statement below:
        //String sql = "CHANGE ME";
        String sql = "select * from faculty inner join students on faculty.class = students.class inner join textbooks on textbooks.class = students.class WHERE faculty.class IN ('Physics', 'Biology')";//TODO: reference SQL - remove me
