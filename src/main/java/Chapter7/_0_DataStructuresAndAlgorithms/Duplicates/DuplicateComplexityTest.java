package Chapter7._0_DataStructuresAndAlgorithms.Duplicates;
...
public class DuplicateComplexityTest {
    ...
    /**
     * Test speed of the two algorithms based on a dataset where there are no duplicates.
     */
    @Test
...
//        get total elapsed time of algorithm
    ...
    /**
     * Test speed of the two algorithms based on a dataset where there is exactly one duplicate pair.
     */
    @Test
...
//        get total elapsed time of algorithm
    ...
    /**
     * This method generates every single 3 character permutation of letters and numbers - 36^3 items.
     */
